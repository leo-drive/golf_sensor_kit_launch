                ...
                parameters=[
                    {
                      ...
                      "is_roi_overlap_segment": tensorrt_yaml_param['is_roi_overlap_segment'],
                      "is_publish_color_mask": tensorrt_yaml_param['is_publish_color_mask'],
                      "overlap_roi_score_threshold": tensorrt_yaml_param['overlap_roi_score_threshold'],
